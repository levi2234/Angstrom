...
def test_motion_amplification_simple():
    """
    Test motion amplification without temporal filtering to isolate the issue.
    """
    ...
    print("Testing motion amplification WITHOUT temporal filtering...")
    ...
    # Apply motion amplification WITHOUT temporal filtering
    print("Applying motion amplification (no temporal filter)...")
    amplification_factor = 10  # Moderate amplification

    # Amplify without frequency range (no temporal filtering)
    ...
    output_path = "test_square_motion_amplified_simple.mp4"
    ...
    print(f"No temporal filtering applied")
...
if __name__ == "__main__":
    test_motion_amplification_simple()